@extends('layouts.app')
@section('page', 'Pengelola Akun Media Sosial')

@section('content')
  <section
    id="HeroSection"
    class="w-[90%] h-dvh mx-auto flex justify-center items-center gap-12"
  >
    <img
    ...
    >
    <div
      class="flex justify-center gap-30"
    >
      <div
        class="w-150"
      >
  ...
  >
    ...
    >
      ...
      <div
        class="p-8 flex flex-col gap-y-3"
      >
  ...
  <section
    id="list-services"
    class="-z-50 w-full h-screen bg-linear-to-br from-white to-[#999797] text-white text-center font-semibold uppercase"
  >
    <div
      class="relative w-[90%] h-full mx-auto px-6 flex justify-evenly items-center gap-12"
    >
      <div class="absolute bottom-0 w-full h-[50vh] bg-linear-to-r from-[#DEDEDE] to-[#313131] border border-[#999797] opacity-55 rounded-t-[3rem]" ></div>
      <h1
        class="absolute top-15 text-4xl text-bg font-normal"
      ><span class="font-bold">Konten Media sosial</span> untuk semua platform</h1>
      <div
        class="z-10 pb-2 px-3 flex flex-col justify-center items-center gap-5 bg-[#C4C4C4] border-3 border-white rounded-3xl"
      >
        <img
        ...
        <a
          href="#instagram"
          class="w-[70%] py-3 uppercase text-bg bg-[#FFC00B] hover:opacity-80 rounded-2xl transition-opacity"
        >Lihat Paket</a>
      </div>
      <div
        class="z-10 pb-2 px-3 flex flex-col justify-center items-center gap-5 bg-[#C4C4C4] border-3 border-white rounded-3xl"
      >
        <img
          ...
          alt="services-ig"
          class="h-20 -mt-10 bg-white rounded-2xl"
        >
        <h1
          class="text-2xl font-bold"
        >Konten Instagram</h1>
  ...
  <section
    id="PaketSection"
    class="w-full h-full py-20 bg-linear-to-br from-white to-[#999797]"
  >
    <div
      class="w-[90%] mx-auto flex flex-col items-center gap-30 text-bg"
    >
      <h1
