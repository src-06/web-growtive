...
@section('content')
  ...
  >
    ...
    >
    <div
      class="w-[90%] h-full mt-20 mx-auto flex justify-evenly items-center gap-20"
    >
      <div
  ...
  <section
    id="WhatSection"
    class="-z-50 relative w-full h-full py-8 bg-linear-to-tl from-white to-[#999797]"
  >
    <div
      class="absolute top-10 left-[calc(1/2*100%-40%)]"
    >
      <img
        src="/assets/images/endors1.png"
        alt="endors1"
        class="z-0 relative top-10 left-10 w-55"
      >
      <img
        src="/assets/images/endors2.png"
        alt="endors2"
        class="z-1 relative top-0 left-30 w-55"
      >
    </div>
    <div
      class="absolute top-20 left-[calc(1/2*100%-7%)] text-bg"
    >
      <div
      ...
      <div
        class="w-130 h-fit mt-13 ml-18 px-3 py-10 bg-white rounded-4xl shadow-2xl shadow-bg/30"
      >
        <h1
          class="mb-4 text-lg font-bold"
    ...
    <div
      class="relative mt-35 pb-30 flex justify-center items-center"
    >
      <img
